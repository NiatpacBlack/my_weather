...
class WeatherApiServiceTest(TestCase):
    ...
    def test_get_weather_by_coords(self):
        self.assertIsInstance(
            get_weather_by_coords(self.my_location, os.getenv("OPENWEATHER_API_KEY") or OPENWEATHER_API_KEY),
            Weather,
        )
        with self.assertRaises(AttributeError):
            get_weather_by_coords((45.23, 125.52), os.getenv("OPENWEATHER_API_KEY") or OPENWEATHER_API_KEY)
